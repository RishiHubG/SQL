...
DROP TABLE IF EXISTS #TMP_ALLSTEPS 
 ...
 --RETURN
	...
	INSERT INTO dbo.TableColumnMaster (ColumnName,UserCreated,DateCreated,UserModified,DateModified,IsActive,VersionNum,CustomFormsInstanceID)
	...
	INSERT INTO dbo.TableColumnMaster_history (ID, ColumnName,UserCreated,DateCreated,UserModified,DateModified,IsActive,VersionNum,CustomFormsInstanceID)
