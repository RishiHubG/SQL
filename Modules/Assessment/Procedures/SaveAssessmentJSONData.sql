...
@RegisterName NVARCHAR(MAX) = NULL,
...
BEGIN TRY
	...
	BEGIN
			...
			--IF @EntityTypeid <> 3 OR @ParentEntityTypeid <> 16
			--BEGIN
			...
			BEGIN
					...
					INSERT INTO dbo.Registers([Name],[Description],AccessControlId,WorkFlowACID,UserCreated,DateCreated,DateModified)
						SELECT @RegisterName, @Description,@AccessControlId,@WorkflowID,@UserLoginID,@CurrentDate,@CurrentDate
			...
			BEGIN
					...
					INSERT INTO dbo.Registers([Name],[Description],ParentID,AccessControlId,WorkFlowACID,UserCreated,DateCreated,DateModified)
						SELECT @RegisterName, @Description,@ParentEntityID, @AccessControlId,@WorkflowID,@UserLoginID,@CurrentDate,@CurrentDate
			...
			--BEGIN TRAN
				...
				EXEC dbo.SaveAssessmentPermissions @InputJSON = @InputJSON,
